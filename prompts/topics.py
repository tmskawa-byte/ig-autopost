...
TOPICS: Dict[str, Dict] = {
    ...
    "topic_3": {
        ...
        "tone": (
            ...
            # 2026-05-30 追加: 保険ネタは1等級vs3等級の対比必須
            "【保険等級に触れる場合の特別ルール】"
            "事故と任意保険の等級ダウンを絡めて書くケースでは、"
            "『1等級ダウン』『3等級ダウン』のいずれかに言及する時に "
            "必ず両方を対比で説明する（片方だけは禁止）。"
    ...
    "topic_6": {
        ...
        "tone": (
            ...
            # 2026-05-30 追加: 保険ネタは1等級vs3等級の対比必須
            "【🚨 保険等級ダウンの特別ルール】"
            "『1等級ダウン』『3等級ダウン』のいずれかに言及する時は、"
            "必ず両方を対比で説明すること。片方だけだと読者が混乱するため厳禁。"
            "1等級ダウン事故の例: 飛び石、盗難、火災、台風被害、落下物など"
            "（自然災害・第三者起因・偶発的物損）。"
            "3等級ダウン事故の例: 対人賠償、対物賠償、自損事故、"
            "一般的な車両保険使用など（運転に起因する事故）。"
            "ノーカウント事故にも触れると更に教育的"
            "（弁護士費用特約のみ使用、ロードサービスのみ使用、無過失の追突被害など）。"
            "例: 「飛び石は1等級ダウンだけど、ぶつけた事故は3等級ダウン」"
            "のように並列で言及する。"
        ),
    },
    "topic_7": {
